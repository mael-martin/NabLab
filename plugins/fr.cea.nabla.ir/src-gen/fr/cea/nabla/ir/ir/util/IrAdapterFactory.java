...
public class IrAdapterFactory extends AdapterFactoryImpl {
	...
	protected IrSwitch<Adapter> modelSwitch =
		new IrSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTimeLoopCopyInstruction(TimeLoopCopyInstruction object) {
				return createTimeLoopCopyInstructionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.cea.nabla.ir.ir.TimeLoopCopyInstruction <em>Time Loop Copy Instruction</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTimeLoopCopyInstructionAdapter() {
		return null;
	}
